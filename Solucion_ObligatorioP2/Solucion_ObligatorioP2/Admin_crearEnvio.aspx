    ...
    <div id="div_crearEnvio_contenedora">
        ...
        <div class="cajitas" style="margin:10px; padding-bottom:60px; padding-left:120px; padding-right:120px; width:260px; clear:both">  
            ...
            <div style="padding-top:10px; clear:both">
                <asp:Label ID="lbl_crearEnvio_nroEnvio" style="float:left;color:blue" CssClass="labels" runat="server" Text="Número de envio generado: "></asp:Label>
            </div>
            <div style="padding-top:10px; clear:both">
        ...
        <asp:Panel ID="PanelDocumento" CssClass="cajitas" style="margin:10px; margin-top:30px; padding:10px; padding-left:120px; padding-right:120px;  width:260px; clear:both"  runat="server" Visible="False">
           ...
           <div style="padding-top:15px; clear:both">
            ...
            <div style="padding-top:15px; clear:both">
                ...
                <asp:TextBox ID="txt_crearEnvio_nroOrigen" style="width:100px ;float:right; margin-left:6px" runat="server" OnTextChanged="txt_crearEnvio_calleOrigen0_TextChanged"></asp:TextBox>
            </div>
            <div style="padding-top:15px; clear:both">
                <asp:Label ID="lbl_crearEnvio_paisOrigen" style="float:left" CssClass="labels" runat="server" Text="Pais:"></asp:Label>
                <asp:TextBox ID="txt_crearEnvio_paisOrigen" style="width:100px ;float:right; margin-left:6px" runat="server" OnTextChanged="txt_crearEnvio_calleOrigen0_TextChanged"></asp:TextBox>
            </div>
            <div style="padding-top:15px; clear:both">
                <asp:Label ID="lbl_crearEnvio_ciudadOrigen" style="float:left" CssClass="labels" runat="server" Text="Ciudad:"></asp:Label>
                <asp:TextBox ID="txt_crearEnvio_ciudadOrigen" style="width:100px ;float:right; margin-left:6px" runat="server" OnTextChanged="txt_crearEnvio_calleOrigen0_TextChanged"></asp:TextBox>
            </div>
            <div style="padding-top:15px;padding-bottom:30px; clear:both">
                ...
                <asp:TextBox ID="txt_crearEnvio_codPostalOrigen" style="width:100px ;float:right; margin-left:6px" runat="server" OnTextChanged="txt_crearEnvio_calleOrigen0_TextChanged"></asp:TextBox>
            </div>
        </asp:Panel>
        <div style="padding-top:15px; clear:both">
